...
<html>
    ...
    <body>
        ...
        <br/>
        <div class="main-text">
        <h1 class="centered-text">View & Edit Supplier List</h1><br/>
        <div class="btn-container">
            <a href="ViewSuppList.php" class="btn" style="color:123499"><b>View Supplier List</b></a>
            <a href="AddSupp.php" class="btn" style="color:123499"><b>Add New Supplier</b></a>
