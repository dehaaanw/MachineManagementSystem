...
<html>
    ...
    <body>
        ...
        <br/>
        <h1 style="text-align:center; color:#3C4142;">Register <span style="color:#ff4f4b;">Matrix Owned</span> Machine.</h1>
        <center>
        ...
        <div class="form-row">
                <div class="col-md-2 mb-2" style="display:none;">
                    <select name="mc_type">
                        <option value="Matrix Owned Machine" selected>On Loan IN</option>
                    </select>
                </div>
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>
                if(confirm('Machine Entered Successfully. Generate Barcode?')) {
                    ...
                    window.location.href = 'MatrixOwned.php';
                }
            </script>";
        } else {
